...
import CustomizedDialogsHazardReport from '../modals/modals-hazard-report';

export const HazardReportTable = (props) => {
  const {
    count = 0,
    items = [],
    onPageChange = () => { },
  ...
  return (
    <Card>
      ...
      <CustomizedDialogsHazardReport open={open} setOpen={setOpen} nama={namaSelected} nrp={nrpSelected} hasil={hasil} hasilMor={hasilMor} hasilAkhir={hasilAkhir} setHasil={setHasil} confirm={confirm} />
    </Card>
  );
};

HazardReportTable.propTypes = {
  ...
  setHazardReportId: PropTypes.any,
};
